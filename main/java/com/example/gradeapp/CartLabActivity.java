...
public class CartLabActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateButton = findViewById(R.id.btnCartAppDate);
        timeButton = findViewById(R.id.btnCartAppTime);
        btnCheckout = findViewById(R.id.buttonCartCheckOut);
        btnBack = findViewById(R.id.buttonCartBack);
        tvTotal = findViewById(R.id.CartTotalPrice);
        lst = findViewById(R.id.CartMultiline);
