...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edConfirm = findViewById(R.id.editTextRegAppExp);
        Database db = new Database(getApplicationContext(),"Grade App",null,1);
            ...
            public void onClick(View view) {
                ...
                else
                {
                    if(password.compareTo(confirmPass)==0)
                    {
                        ...
                        {
                            Toast.makeText(getApplicationContext(),"Password must contain atleast 8 characters,having letter ,characters and symbols",Toast.LENGTH_SHORT).show();
                        }
                    }
                    else
                    {
